...
# Part 1: Define function for pulling, processing, and creating technical indicators
...
interval_mapping = {  # Corrected the typo from 'internal_mapping' to 'interval_mapping'
    '1d': '1m',
    '1wk': '30m',
    '1mo': '1d',
    '1y': '1wk',
...
if st.sidebar.button('Update'):
    ...
    if data.empty:
        st.error("Failed to fetch stock data. Please check the ticker symbol or try again later.")
    else:
...
st.sidebar.info('This dashboard provides stock data and technical indicators for various time periods. Use the sidebar to navigate.')
